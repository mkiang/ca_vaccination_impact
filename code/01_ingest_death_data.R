...
## 
## The raw death data are decedent-level files located on UCSF's secure 
## compute environment. This code finds the most recent version of that file,
## cleans it up, removes unnecessarily (potentially identifying) information,
## and then saves it for processing late. 
## 
## NOTE: The output of this file is *still decedent-level* and therefore is 
...
if (!fs::file_exists(paste0(SAVE_DIR, "cleaned_line_data.RDS")) | 
    ...
    min_data <- raw_data %>%
        dplyr::select(
            ...
            county_fip = county.province.of.residence.cdph,
